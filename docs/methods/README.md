...
- [`behavior.md`](behavior.md) — the stock/flow evidence and its reconciliation.
- [`bands.md`](bands.md) — expectation bands from an in-context model.
- [`whatif.md`](whatif.md) — scenarios as plan-rewrite replay.
